                    ...
                    <thead>
                      <tr className="border-b border-slate-100 sticky top-0 bg-white z-10">
                        ...
                        <th
                          ...
                          className="group p-5 text-xs font-black uppercase tracking-widest cursor-pointer hover:bg-slate-50 select-none"
                        >
                          <div
                        ...
                        <th
                          ...
                          className="group p-5 text-xs font-bold uppercase tracking-widest cursor-pointer hover:bg-slate-50 select-none text-slate-400"
                        >
                          <div
                            className={`flex items-center gap-1.5 ${
                ...
                <div className="p-6 flex flex-col gap-3">
                  {data.aktivitas.length === 0 ? (
                    ...
                    data.aktivitas.map((item, index) => (
                      <div
                        key={item.id || index}
                        className="flex justify-between items-start p-4 rounded-2xl border border-slate-100 bg-slate-50/30 hover:bg-slate-50 hover:shadow-sm transition-all cursor-pointer"
                      >
                        <div>
