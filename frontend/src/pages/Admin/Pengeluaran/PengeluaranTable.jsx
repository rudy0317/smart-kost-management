          ...
          <thead className="sticky top-0 z-10 bg-white/90 backdrop-blur-md shadow-sm">
            <tr className="border-b border-slate-100">
              ...
              <th
                ...
                className={`${thStyle} cursor-pointer hover:bg-slate-50 text-right`}
              >
              ...
              {data.length === 0 ? (
                ...
                data.map((item) => (
                  <motion.tr
                    ...
                    exit={{ opacity: 0, y: -20 }}
                    layout
                    className="hover:bg-slate-50/50:bg-slate-700/50"
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      ...
                      <div className="flex justify-center gap-2">
                        ...
                        <motion.button
                          ...
                          className="p-2.5 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600:bg-indigo-500 hover:text-white:text-white transition-all shadow-sm"
                        >
                          <svg
                            className="h-5 w-5"
                            fill="none"
