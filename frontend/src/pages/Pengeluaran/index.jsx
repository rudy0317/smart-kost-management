      ...
      >
        ...
        <div className="flex gap-4 mb-6">
          <input
            ...
            className="flex-1 px-4 py-3 bg-white rounded-2xl border border-slate-200 shadow-sm focus:ring-4 focus:ring-indigo-50 outline-none"
          />
          <div className="relative">
            <button
              onClick={() => setIsFilterOpen(!isFilterOpen)}
              className="px-4 py-3 bg-white rounded-2xl border border-slate-200 shadow-sm hover:bg-slate-50 transition-colors font-medium text-slate-600"
            >
