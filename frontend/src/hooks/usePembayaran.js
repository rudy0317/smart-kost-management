...
export const usePembayaran = () => {
  ...
  const statusColor = (status) => {
    ...
    if (status === "menunggu_verifikasi") return "bg-blue-100 text-blue-800 border-blue-200";
    if (status === "belum_lunas") return "bg-amber-100 text-amber-800 border-amber-200";
